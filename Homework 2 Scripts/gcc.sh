...
#$ -N gcc    # Change this for each benchmark
#$ -pe omp 1
#$ -o /projectnb/ec513/students/jy0825/HW2/Tests/output_gcc.log
#$ -e /projectnb/ec513/students/jy0825/HW2/Tests/error_gcc.log                  
#$ -m ea                 
