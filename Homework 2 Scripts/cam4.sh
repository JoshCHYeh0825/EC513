...
#$ -N cam4    # Change this for each benchmark
#$ -pe omp 1
#$ -o /projectnb/ec513/students/jy0825/HW2/Tests/output_cam4.log
#$ -e /projectnb/ec513/students/jy0825/HW2/Tests/error_cam4.log                  
#$ -m ea                 
