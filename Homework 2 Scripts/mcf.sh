...
#$ -N mcf  # Change this for each benchmark
#$ -pe omp 1
#$ -o /projectnb/ec513/students/jy0825/HW2/Tests/output_mcf.log
#$ -e /projectnb/ec513/students/jy0825/HW2/Tests/error_mcf.log                  
#$ -m ea                 
